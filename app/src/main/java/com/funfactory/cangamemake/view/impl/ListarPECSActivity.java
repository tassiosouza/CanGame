...
public class ListarPECSActivity extends GenericActivity implements IListarPECSActivity {
     ...
     * Presenters
     */
    private IListarPECSPresenter mPresenter = new ListarPECSPresenter();
    ...
    public void setEmptyView(int stringID) {
        ...
        imageView.setImageResource(R.drawable.big_icon_for_emp_list_pecs);
    }
