 ...
 */
@Singleton
public final class CanGameDatabase extends SQLiteOpenHelper implements IDBManager {
    ...
    private static CanGameDatabase sInstance;

    public static CanGameDatabase getInstance() {
        if (sInstance == null) {
            sInstance = new CanGameDatabase(CanGameMake.getContext());
        }
        return sInstance;
    }
     ...
     */
    @Inject
    public CanGameDatabase(final Context androidContext) {
    ...
    public void onCreate(final SQLiteDatabase sqlitedb) {
        ...
        for (String query : InicialInputData.getConfigurationQueries()) {
     ...
     */
    @Override
    public void onUpgrade(final SQLiteDatabase sqlitedb, final int oldVersion, final int newVersion) {
        /*
         * if (oldVersion < DATABASE_VERSION_V10) { executeSQL(getStatementSql(DB_SQL_V2), sqlitedb); }
         * 
         * if (oldVersion < DATABASE_VERSION_V11) { executeSQL(getStatementSql(DB_SQL_V3), sqlitedb); }
         */
    }
     ...
     * (non-Javadoc)
     * 
     * @see br.org.sidi.smartcatalog.model.db.IDBManager#enableForeignKeys(boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see br.org.sidi.smartcatalog.model.db.IDBManager#executeSQLFile(java.lang .String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see br.org.sidi.smartcatalog.model.db.IDBManager#executeSQL(java.lang.String [])
     */
     ...
     * (non-Javadoc)
     * 
     * @see br.org.sidi.smartcatalog.model.db.IDBManager#getStatementSql(java.lang .String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see br.org.sidi.smartcatalog.model.db.ITransactionSupport#beginTransaction()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see br.org.sidi.smartcatalog.model.db.ITransactionSupport#endTransaction()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see br.org.sidi.smartcatalog.model.db.ITransactionSupport#setSuccessfull()
     */
    @Override
